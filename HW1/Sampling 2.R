...
# 5. Assign to a variable `prob` the number of elements of `random_sum` equal to 0 and divide it by 10000. 
...
random_seq <- sample(0:1, size=50000, replace=T)

## Do not modify this line! ## Write your code for 3. after this line! ##

random_mat <- matrix(data=random_seq, nrow=5, ncol = 10000)

## Do not modify this line! ## Write your code for 4. after this line! ##

length(colSums(random_mat))
